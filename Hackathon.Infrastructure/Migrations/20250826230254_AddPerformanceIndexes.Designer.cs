...
namespace Hackathon.Infrastructure.Migrations
{
    ...
    [Migration("20250826230254_AddPerformanceIndexes")]
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.MetricaRequisicao", b =>
                {
                    ...
                    b.ToTable("METRICA_REQUISICAO", "main");
                });
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.ResultadoSimulacao", b =>
                {
                    ...
                    b.ToTable("RESULTADO_SIMULACAO", "main");
                });
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.Simulacao", b =>
                {
                    ...
                    b.ToTable("SIMULACAO", "main");
                });

            modelBuilder.Entity("Hackathon.Domain.Entities.VolumeSimuladoAgregado", b =>
                {
                    b.Property<int>("CodigoProduto")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("TaxaMediaJuro")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("ValorMedioPrestacao")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("ValorTotalCredito")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("ValorTotalDesejado")
                        .HasColumnType("TEXT");

                    b.ToTable("VolumeSimuladoAgregado", "main");
                });
